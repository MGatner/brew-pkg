class BrewPkg < Formula
  ...
  homepage "https://github.com/mgatner/homebrew-pkg"
  url "https://github.com/mgatner/homebrew-pkg.git", :tag => "v2.0.1" 

  head "https://github.com/mgatner/homebrew-pkg.git"
  ...
  def install
    ...
    def caveats
        <<~EOS
          You can uninstall this formula, as `brew tap mgatner/pkg` is all that's
